...
//		IDureeSaisie dureeSaisi = (t1, t2) -> {
//				//long duree = Duration.between(t1, t2).toNanos();
//				System.out.println("durée de la saisie : " + Duration.between(t1, t2).toNanos());
//			};
...
//			 }
			...
			Achat a = new Achat(intitule, Integer.parseInt(qte), d);
			achats.add(a);
	...
	private static Duration calculTemptrtm(Instant t1) {
		Instant t2 = Instant.now();
		Duration duree = Duration.between(t1, t2);
		System.out.println("durée de la saisie : " + Duration.between(t1, t2));
		return duree;
